...
export function SystemPulse({ 
  ...
  return (
    <Badge variant="outline" className={`${status.color} border-none gap-2 px-3 py-1 uppercase text-[10px] font-bold tracking-widest transition-all duration-500 shadow-sm`}>
      <StatusIcon size={12} />
      {status.label}
    </Badge>
  );
